...
class MedicalWasteDetails extends StatefulWidget {
  const MedicalWasteDetails({super.key});
  static const String routeName = '/medicalWasteDetails';

  @override
  State<MedicalWasteDetails> createState() => _MedicalWasteDetailsState();
}

class _MedicalWasteDetailsState extends State<MedicalWasteDetails> {
  final List<Map<String, String>> reasons = [
    {'icon': AppSvgs.kShopeefoodDriver, 'text': 'Face Masks'},
    {'icon': AppSvgs.kTissuePaper, 'text': 'Gloves'},
    {'icon': AppSvgs.kDamageMap, 'text': 'Swabs and Bandages'},
    {'icon': AppSvgs.kClothesOutline, 'text': 'Springs and Syringes'},
    {'icon': AppSvgs.kLucideHouse, 'text': 'All kind of medical waste'},
  ];
